...
fetch('https://mcqapi.onrender.com/api/quiz', {
  method: 'POST',
...
getNewQuestion = () => {
  ...
  if (questionCounter === MAX_QUESTIONS) {
    ...
    fetch('https://mcqapi.onrender.com/api/quiz/result', requestOptions)
      ...
      .then((result) => {
        console.log(result);
        // Redirect to Facebook after result has been published
        localStorage.setItem('mostRecentScore', score);

        window.location.href = 'https://muhammadp3.sg-host.com/Topics/end.html';
    })
